    ...
    public EditQuestion() {
        ...
        saveTest.addActionListener(new ActionListener() {
                                       ...
                                       public void actionPerformed(ActionEvent e) {
                                           ...
                                           try {
                                               dbManager.executeUpdate("UPDATE questions SET question ='"
                                                                       + question.getText() + "' WHERE question='"
                                                                       + questionText + "'");
                                               dbManager.executeUpdate("UPDATE correctAnswers SET answer = '"
                                                                       + answer1.getText() + "' WHERE answer = '"
                                                                       + answerText1 + "'");
                                               dbManager.executeUpdate("UPDATE correctAnswers SET answer = '"
                                                                       + answer2.getText() + "' WHERE answer = '"
                                                                       + answerText2 + "'");
                                               dbManager.executeUpdate("UPDATE correctAnswers SET answer = '"
                                                                       + asnwer3.getText() + "' WHERE answer = '"
                                                                       + answerText3 + "'");
                                               dbManager.executeUpdate("UPDATE correctAnswers SET answer = '"
                                                                       + answer4.getText() + "' WHERE answer = '"
                                                                       + answerText4 + "'");
                                               dbManager.executeUpdate("UPDATE wrongAnswers SET answer = '"
                                                                       + answer5.getText() + "' WHERE answer = '"
                                                                       + answerText5 + "'");
